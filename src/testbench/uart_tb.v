...
uart #(.width(data_width),.clk_freq(XTAL_CLK),.baud_rate(baud_rate)) dut(
    .sys_clk(sys_clk),
    .sys_rst(sys_rst),
    ...
    .uart_rec_data_h(dut_uart_xmit_datah),
 
    .uart_xmit_data_h(dut_uart_xmit_datah),
    .xmit_done_h(dut_xmit_doneH),
    .xmit_active(dut_xmit_active),
 
    .rec_ready(dut_rec_readyh),
    .rec_busy(dut_rec_busyh),
    .rec_data_h(dut_rec_datah),
    .baud_op_clk(ref_uart_clk)
);
 
 
reference #(.data_width(data_width),.clk_value(XTAL_CLK),.baud(baud_rate)) ref(
    .sys_clk(sys_clk),
    .sys_rst_l(sys_rst),
